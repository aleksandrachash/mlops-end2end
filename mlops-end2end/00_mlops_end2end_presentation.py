...
# MAGIC To run this demo, just select the cluster `dbdemos-mlops-end2end-aleksandra_chashchina` from the dropdown menu ([open cluster configuration](https://adb-984752964297111.11.azuredatabricks.net/#setting/clusters/0308-114959-662241yf/configuration)). <br />
...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=984752964297111&notebook=%2F00_mlops_end2end_presentation&demo_name=mlops-end2end&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F00_mlops_end2end_presentation&version=1">
...
# MAGIC
# MAGIC Ultimately, we will be able to build a [complete DBSQL Churn Dashboard](/sql/dashboards/0f99ce4d-aeaa-483b-a239-fdb20cb7fa25-churn-prediction-dashboard---universal?o=1444828305810485#) containing all our customer & churn information!
